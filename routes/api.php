...
use App\Http\Controllers\Api\ClienteController; // (si después lo renombrás a SocioController, mejor)
...
// ❌ Sacado: CupoController y links públicos por token (no lo queremos y rompía route:list)
// Route::get('/cupo/confirmar/{token}', ...);
// Route::get('/cupo/liberar/{token}', ...);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Inscripciones por turno (detalle)
    ...
    // Resource (siempre después de las fijas)
    ...
    Route::prefix('socio')->group(function () {
        ...
        // (opcional) para “confirmar/liberar” interno, lo activamos cuando creemos los métodos:
        // Route::post('/inscripciones/{id}/confirmar', [ClienteController::class, 'confirmarInscripcion']);
        // Route::post('/inscripciones/{id}/liberar', [ClienteController::class, 'liberarInscripcion']);
    });
    ...
    Route::prefix('notificaciones')->group(function () {
        ...
        Route::put('/{id}/leida', [NotificacionesController::class, 'marcarComoLeido']);
